...
public class ClerkMenuController {
    ...
    private void goEditAndSearchPatient(MouseEvent event) throws IOException {
        AnchorPane editAndSearchPatientPage = FXMLLoader.load(getClass().getResource("/gui/fxml/clerkGUI/editAndSearchPatient.fxml"));
    ...
    private void goSearchAndVisitPatient(MouseEvent event) throws IOException {
        AnchorPane searchAndVisitPatientPage = FXMLLoader.load(getClass().getResource("/gui/fxml/clerkGUI/searchAndVisitPatient.fxml"));
