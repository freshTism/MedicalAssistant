...
public class EditAndSearchPatientController {
    ...
    private void goSearchAndVisitPatient(MouseEvent event) throws IOException {
        AnchorPane searchAndVisitPatientPage = FXMLLoader.load(getClass()
                .getResource("/gui/fxml/clerkGUI/searchAndVisitPatient.fxml"));
    ...
    private void searchPatient(MouseEvent event) throws IOException {
        ...
        AnchorPane showAndEditPatientInformationPage = FXMLLoader.load(getClass()
                .getResource("/gui/fxml/clerkGUI/doctorShowAndEditPatientInformation.fxml"));
