...
public class PatientsAccordingToAgeController {
    ...
    @FXML
    private JFXTextField searchingAgeTF;
    @FXML
    ...
    void searchPatient(MouseEvent event) {
        ...
        int enteredAge = Integer.parseInt(searchingAgeTF.getText());

        try {
            result = Doctor.searchWithAge(enteredAge);
